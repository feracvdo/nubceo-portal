...
// Hitos para clientes autoimplementados: mapean 1:1 a los 7 pasos de la guía.
// Usan los mismos nombres que contenido.js para que el cliente reconozca cada paso.
export function hitosAutoimpPara() {
  return [
    { id: "auto_1", nombre: "Tu equipo (crear roles e invitar personas)", responsable: "Cliente" },
    { id: "auto_2", nombre: "Sucursales y comercios", responsable: "Cliente" },
    { id: "auto_3", nombre: "Origen de las ventas (CSV / API / ambos)", responsable: "Cliente" },
    { id: "auto_4", nombre: "Reglas y secuencias de conciliación", responsable: "Cliente" },
    { id: "auto_5", nombre: "Primera conciliación", responsable: "Cliente" },
    { id: "auto_6", nombre: "Tu rutina diaria con Nubceo", responsable: "Cliente" },
    { id: "auto_7", nombre: "Conocé más (funcionalidades avanzadas)", responsable: "Cliente" },
  ];
}
