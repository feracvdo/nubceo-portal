...
export const STEPS = [
  ...
  },
  {
    ...
    descargas: [
      { t: "Plantilla de carga de ventas (Excel)", url: "/descargas/plantilla-ventas-nubceo.xlsx" },
      { t: "Especificación de la API de ventas (PDF)", url: "/descargas/especificacion-api-ventas-nubceo.pdf" },
    ],
    herramienta: "csv",
    fork: {
