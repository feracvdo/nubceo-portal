...
export const STEPS = [
  ...
  },
  {
    nav: "Sucursales",
    kicker: "Paso 2 de 7",
    title: "Cargá tus sucursales",
    lead:
      "Tu referente ya dejó creadas las sucursales cabecera. Ahora te toca cargar tus sucursales reales, una por cada local o punto de venta que tengas. Cada venta y cada liquidación va a quedar asociada a una de ellas, así que este listado es la base de todos tus reportes: si una sucursal falta acá, sus ventas después no tienen dónde caer.",
    videos: [
      { t: "Qué es una sucursal y cómo se relaciona con la cabecera", d: "1:30" },
      { t: "Cargar sucursales una por una", d: "2:05" },
      { t: "Importar muchas sucursales con la plantilla de Excel", d: "1:40" },
    ],
    path: "Configuración → Sucursales",
    todo: [
      "Hacé la lista de todos tus locales activos, incluso los que abrieron hace poco.",
      "Si son pocos, cargalos uno por uno; si son muchos, usá la plantilla de Excel.",
      "Asociá cada sucursal a la cabecera que la factura.",
      "Revisá que los nombres coincidan con los que usás en tu sistema de ventas.",
    ],
    verify:
      "En el listado de Sucursales tenés que ver todos tus locales activos, cada uno colgando de su cabecera. <b>Contá cuántos son y comparalo con tu lista: el número tiene que dar exacto.</b> Si te falta uno, sus ventas no van a conciliar y el problema recién se ve al final, cuando el resultado da bajo y no se entiende por qué.",
    fork: null,
    _pend: [
      "Nombre exacto del botón de importación y de las columnas de la plantilla.",
      "¿La plantilla admite indicar la cabecera por CUIT o por nombre?",
  ...
  },
  {
    ...
    kicker: "Paso 3 de 7",
    title: "Asociá cada sucursal con su número de comercio",
    lead:
      "Cada procesadora identifica tus locales con su propio código, que no tiene nada que ver con el nombre que vos les ponés. Este paso es el que le permite a Nubceo saber que el comercio 1099384 de Mercado Pago es tu sucursal de Castelar. Es el paso más importante de toda la configuración y el único donde un error no se ve: si un código queda cruzado, no aparece ningún aviso, las ventas simplemente concilian contra el local equivocado y todos tus reportes quedan mal.",
    videos: [
      { t: "Qué es el número de comercio y dónde encontrarlo", d: "1:35" },
      { t: "Cargar el mapeo en Nubceo, plataforma por plataforma", d: "2:20" },
      { t: "Los casos raros: un local con dos códigos, un código para dos locales", d: "1:40" },
    ],
    path: "Configuración → Sucursales → Códigos externos",
    todo: [
      "Pedile a cada procesadora el listado de comercios activos, o descargalo de su portal.",
      "Cargá los códigos de una procesadora completa antes de pasar a la siguiente.",
      "Anotá aparte los comercios que no puedas asociar a ningún local.",
      "Revisá el listado final comparándolo contra el listado de la procesadora.",
    ],
    verify:
      "Tomá el listado de comercios que te dio la procesadora y recorrelo línea por línea contra lo que cargaste en Nubceo: tienen que dar la misma cantidad y las mismas asociaciones. Es tedioso y vale la pena, porque es el único chequeo que existe. <b>Si te sobran comercios en el listado de la procesadora</b>, puede haber locales cerrados o terminales que no sabías que estaban activas, y las dos cosas conviene saberlas ahora.",
    fork: null,
    _pend: [
      "Ruta y nombre exactos de la pantalla de códigos externos.",
      "¿Hay carga masiva de códigos o solo uno por uno?",
      "¿Qué hace el sistema si dos sucursales comparten un mismo código?",
    ],
  },
  {
