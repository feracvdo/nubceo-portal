...
export const STEPS = [
  ...
  },
  {
    ...
    ejemplo: {
      ...
      nota: "Cada fila es un <b>número de comercio</b>, no un local. Un mismo local puede tener varios números (uno por procesadora o por terminal). Completá todos y Nubceo los agrupa solo.",
    },
    casoEspecial: {
      titulo: "¿Todas tus sucursales operan bajo un mismo número de comercio?",
      texto: "Es un caso válido: si la procesadora te dio un solo número y todas tus ventas se liquidan ahí, cargá <b>una sola sucursal cabecera</b> con ese número. No hace falta inventar sucursales separadas. El mapeo sigue siendo el mismo: una fila en el Excel, un número de comercio, una sucursal cabecera.",
    },
    verify:
  ...
  },
  {
    ...
    fork: {
      ...
      ambos: {
        ...
        d: "Un punto de venta se integra por API y otro manda las ventas por archivo. Hacés los dos caminos: elegí con cuál empezar.",
      },
    },
    _pend: [],
  },
